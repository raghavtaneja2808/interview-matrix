  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-6 md:px-12 bg-transparent">
      ...
      <button
        ...
        className="flex items-center justify-center rounded-lg h-12 px-6 bg-[#111111] hover:bg-black transition-colors duration-200 text-white text-[15px] font-medium tracking-wide cursor-pointer"
      >
