...
const TopBar = () => {
  return (
    <header className="fixed top-0 left-[280px] right-0 h-[58px] bg-surface border-b border-border-light flex items-center px-6 gap-3 z-30">
      <button className="flex items-center gap-2 h-9 px-4 rounded-lg bg-accent hover:bg-accent-dark text-white text-[13px] font-semibold transition-colors duration-200">
        <PlusIcon />
        Start Interview
      </button>
